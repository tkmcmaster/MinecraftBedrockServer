...
# curl https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/SetupMinecraft.sh | bash
#
...
Update_Scripts() {
  ...
  curl -H "Accept-Encoding: identity" -L -o start.sh https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/start.sh
  chmod +x start.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o stop.sh https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/stop.sh
  chmod +x stop.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o restart.sh https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/restart.sh
  chmod +x restart.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o fixpermissions.sh https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/fixpermissions.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o revert.sh https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/revert.sh
  chmod +x revert.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o clean.sh https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/clean.sh
  chmod +x clean.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o update.sh https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/update.sh
  chmod +x update.sh
...
Check_Architecture() {
  ...
  if [[ "$CPUArch" == *"aarch"* ]]; then
    ...
    curl -H "Accept-Encoding: identity" -L -o depends.zip https://raw.githubusercontent.com/tkmcmaster/MinecraftBedrockServer/mcmaster-personalize/depends.zip
    unzip depends.zip
    sudo mkdir /lib64
