...
<br>
If you are looking for a Docker containerized version of the Minecraft Bedrock Dedicated Server, it is available here:  <a href="https://github.com/tkmcmaster/Legendary-Bedrock-Container">https://github.com/tkmcmaster/Legendary-Bedrock-Container</a>
...
<ul>
  ...
  <li>July 24th 2022</li>
    <ul>
        <li>Use libssl1.1 from repository instead of Ubuntu servers due to it changing every week or two (thanks theblujuice, <a href="https://github.com/tkmcmaster/MinecraftBedrockServer/issues/129">issue #129)</a></li>
    </ul>
  ...
  <li>July 7th 2022</li>
    <ul>
        ...
        <li>Punctuation / grammar fixes to README (thanks TheWilbo, <a href="https://github.com/tkmcmaster/MinecraftBedrockServer/pull/128">pull request #128)</a></li>
    </ul>
  ...
  <ul>
    <li>Removed /sbin qualifier from route command as the PATH variable is now stored at the top of each script by SetupMinecraft.sh (thanks LookedPath, <a href="https://github.com/tkmcmaster/MinecraftBedrockServer/issues/120">issue #120</a>)</li>
  </ul>
  <li>March 10th 2022</li>
  <ul>
    <li>Add new allowlist.json to the unzip whitelist (thanks shaman79, <a href="https://github.com/tkmcmaster/MinecraftBedrockServer/issues/118">issue #118</a>)</li>
    <li>Added buy a coffe / donation information (thanks vandersonmota, <a href="https://github.com/tkmcmaster/MinecraftBedrockServer/issues/117">issue #117</a>)</li>
  </ul>
